...
/** 6.METHODE PRINCIPALE: main() **/
	public static void main(String[] args) {
		...
		*/
		System.out.println("\n1. Cr�er un pointeur c'est diff�rent que de cr�er un objet");
		Ingredients ingredient10 = new Ingredients("lait", 10);	// On cr�e le pointeur ingredients10, 
		...
		System.out.println("1er pointeur"+ ingredient21.toString());	// d. affichage via 1er pointeur
		System.out.println("2eme pointeur"+ ingredient22.toString());	// d. affichage via 2�me pointeur
		ingredient21.set_quantite(5);	// e. modifier l'objet via le 1er pointeur
		System.out.println("1er pointeur"+ ingredient21.toString());	// f. affichage via 1er pointeur
		System.out.println("2eme pointeur"+ ingredient22.toString());	//    et 2�me pointeur
		...
		Ingredients ingredients31;	// b. cr�e le 1er pointeur    ingredient31
		ingredients31 = new Ingredients("milk", 31);	// b. le 1er pointeur prend l'@ d'un ouvel objet <"milk", 31>
		Ingredients ingredients32;	// c. cr�e le 2�me pointeur   ingredient32
		ingredients32 = ingredients31;	// c. le 2�me pointeur prend l'@ du 2�me objet qui est construit
                                //    sur la base du 1er objet, cad construit par recopie
		System.out.println("1er pointeur"+ ingredients31.toString());	// d. affichage de ce que pointe    ingredient31
		System.out.println("2eme pointeur"+ ingredients32.toString());	// d. affichage de ce que pointe    ingredient32
		ingredients32.set_quantite(5);	// e. modification de l'un des 2 objets
		System.out.println("1er pointeur"+ ingredients31.toString());	// f. affichage  de ce que pointe    ingredient31
		System.out.println("2eme pointeur"+ ingredients32.toString());	// f. affichage  de ce que pointe    ingredient32
		...
		Ingredients ingredients41 = new Ingredients("Sel", 41);	// a. cr�er un objet <"salt", 41> point� par ingredient41
		Ingredients ingredients42 = new Ingredients(ingredients41);;	// b. copier le pointeur dans un second pointeur ingredient42
		System.out.println("1er pointeur"+ ingredients41.toString() + ingredients42.toString());	// c. observer que ingredient41 et ingredien42 sont �gaux

		System.out.println("\n   4.b Comparer deux objets => la m�thode boolean equals(objetModele)");
		Ingredients ingredients43 = new Ingredients("vin", 49);	// a. cr�er un objet point� par ingredient43 aux valeurs <"vin", 49>
		Ingredients ingredients44 = new Ingredients("vin", 49);	// b. cr�er un 2�me objet point� par ingredient44 aux m�mes valeurs <"vin", 49>
